/**
 * Mojo Manor — Cloudflare Worker
 * Handles POST /api/chat → Anthropic Claude API
 *
...
- Panacea Brewing Company — excellent local craft beer
- Sweet Onion Restaurant — local favorite for dinner
- Bogart's Restaurant & Bar
- Public House Restaurant
- The Strand at 38 Main — live music venue

**Outdoor Adventures:**
- Blue Ridge Parkway — 5 minutes away, stunning drives and hikes
- Great Smoky Mountains National Park — 30 minutes
- Cataloochee Valley (elk viewing, hiking) — 30 minutes
- Max Patch — iconic bald mountain hike, 360° views — 40 minutes
- Waterrock Knob — short hike with incredible views — 20 minutes
- Flat Creek Trail — easy to moderate hike nearby
- Maggie Valley — 10 minutes (skiing at Cataloochee Ski Area in winter)

**Day Trips:**
- Asheville, NC — 30 minutes (River Arts District, Biltmore Estate, tons of restaurants)
- Cherokee, NC — 20 minutes (Harrah's Casino, Cherokee cultural sites)
- Bryson City — 30 minutes (Nantahala Outdoor Center, whitewater rafting)
